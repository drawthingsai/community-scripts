...
const styleChoices = ["Oil Painting", "Cartoon", "Anime", "PixArt"];
...
switch (userSelection[0][0]) {
  ...
  case 0:
    ...
    pipeline.downloadBuiltins(["oilpainting_oilpaintingv10_f16.ckpt", "ip_adapter_plus_sd_v1.x_open_clip_h14_f16.ckpt", "controlnet_depth_1.x_v1.1_f16.ckpt"]);
  ...
  case 1:
    ...
    pipeline.downloadBuiltins(["disney_pixar_cartoon_type_b_q6p_q8p.ckpt", "ip_adapter_plus_sd_v1.x_open_clip_h14_f16.ckpt", "controlnet_depth_1.x_v1.1_f16.ckpt"]);
  ...
  case 2:
    ...
    pipeline.downloadBuiltins(["rev_animated_v1.22_q6p_q8p.ckpt", "ip_adapter_plus_sd_v1.x_open_clip_h14_f16.ckpt", "controlnet_depth_1.x_v1.1_f16.ckpt"]);
  ...
  case 3:
    ...
    pipeline.downloadBuiltins(["juggernaut_xl_v9_q6p_q8p.ckpt", "pixel_art_xl_v1.1_lora_f16.ckpt", "ip_adapter_plus_xl_base_open_clip_h14_f16.ckpt", "controlnet_depth_sdxl_v1.0_mid_f16.ckpt"]);
    ...
    depthMapControl.weight = 1;
    ipAdapterControl = pipeline.findControlByName("IP Adapter Plus (SDXL Base)");
    ipAdapterControl.weight = 1;
    ipAdapterControl.guidanceEnd = 0.6;
    canvas.loadMoodboardFromSrc(moodboardSrc);
